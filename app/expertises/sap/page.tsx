  ...
  const services = [
    {
      ...
      description: "Déploiement et configuration de solutions SAP",
    },
    {
      icon: Workflow,
      title: "Integration",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Nos consultants SAP certifiés vous accompagnent dans l'implémentation, 
              l'intégration et l'évolution de vos solutions SAP.
            </p>
            <Link href="/#contact">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8">
                Nos experts SAP maîtrisent l'ensemble des modules et vous accompagnent 
